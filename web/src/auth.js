// Einbau ID — same pattern as PUNCH/SCOUT/INTAKE/TALLY. Own login screen, calls
// auth-worker's /auth/login directly, stores the token in localStorage, attaches
// it as `Authorization: Bearer` on every call to handoff-worker.
...
const AUTH_BASE = import.meta.env.DEV ? "" : import.meta.env.VITE_AUTH_API || "https://auth.ben-a90.workers.dev";
